...
<div class="panel panel-default">
    <div class="panel-body">
        <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="userFormProject" id="userFormProject" class="form-validate form-vertical" onsubmit="return validateForm(this);" enctype="multipart/form-data" novalidate>
...
<?php endif; ?>
            <fieldset>
                <div class="panel panel-default">
                    <div class="panel-heading"><h4><?php echo JText::_('COM_JBLANCE_YOUR_PROJECT_DETAILS'); ?></h4></div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="control-label" for="project_title"><?php echo JText::_('COM_JBLANCE_PROJECT_TITLE'); ?> <span class="redfont">*</span>:</label>
                            <div class="controls">
                                <input type="text" class="form-control required" name="project_title" id="project_title" value="<?php echo $this->row->project_title; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
...
echo JHtml::_('calendar', $startdate, 'start_date', 'start_date', '%Y-%m-%d', array('class' => 'form-control required', 'size' => '20', 'maxlength' => '32'));
?>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input type="text" class="form-control required validate-numeric" name="expires" id="expires" value="<?php echo $this->row->expires; ?>" />
...
?>
                        ...
                        <div data-project-type="fixed">
                            <div class="form-group">
                                ...
                                <div class="controls">
<?php
$attribs = 'class="form-control required advancedSelect"';
...
<?php if ($this->row->id_location > 0) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <textarea name="description" id="description" class="form-control required hasTooltip" rows="5" style="max-height: 300px;"><?php echo JFilterInput::getInstance()->clean($this->row->description, 'string'); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
for ($i = 0; $i < $fileLimitConf; $i++) {
    ?>
                                ...
                                <?php foreach ($this->projfiles as $projfile) { ?>
    ...
    foreach ($parents as $pt) {
        ?>
            ...
            <div class="font14 boldfont">
                <?php if ($reviewProjects && !$this->row->approved) { ?>
