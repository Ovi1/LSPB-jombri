      ...
      <div class="control-group">
        ...
        <div class="controls">
          <label class="checkbox inline" for="">
            <input type="checkbox" id="fixed" name="project_type[fixed]" value="COM_JBLANCE_FIXED" <?php if (isset($proj_type['fixed'])) {
            echo 'checked';
          } ?> ><?php echo JText::_('COM_JBLANCE_FIXED'); ?>
          </label> 
          <label class="checkbox inline">
            <!-- <input type="hidden" name="project_type['hourly']" value="0" /> -->
            <input type="checkbox" id="hourly" name="project_type[hourly]" value="COM_JBLANCE_HOURLY" <?php if (isset($proj_type['hourly'])) {
            echo 'checked';
...
?>
      ...
      <button type="submit" class="btn btn-primary pull-right" title=""><i class="material-icons">search</i> <?php echo JHtml::tooltipText('COM_JBLANCE_SEARCH'); ?></button>
    </div>
  </div>
  </div>
