...
<form class="form-horizontal" action="<?php echo $action; ?>" method="get" name="userFormJob" enctype="multipart/form-data">
...
<?php echo JText::_('COM_JBLANCE_PROJECT_STATUS'); ?>
      ...
      <div class="col-md-3">
        <div class="form-group">
          <label class="control-label" for="project_type"><?php echo JText::_('COM_JBLANCE_PROJECT_TYPE'); ?>
          </label>
          <div class="checkbox">
            <label class="" for="">
