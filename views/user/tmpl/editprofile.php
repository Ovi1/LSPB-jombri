...
<?php include_once(JPATH_COMPONENT . '/views/profilemenu.php'); ?>
    ...
    <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="editProfile" id="frmEditProfile" class="form-validate form-vertical" onsubmit="return validateForm(this);" enctype="multipart/form-data" novalidate>
     ...
     <div class="panel panel-default" style="border:0" >
         <!--<div class="panel-heading" style="border-radius: 0"><h3><?php echo JText::_('COM_JBLANCE_EDIT_PROFILE'); ?></h3></div>-->
                                    ...
                                    if ($ct->parent == $pt->id) {
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                ?>
                                                <label class="" for="custom_field_<?php echo $ct->id . $labelsuffix; ?>"><?php echo JText::_($ct->field_title); ?>
