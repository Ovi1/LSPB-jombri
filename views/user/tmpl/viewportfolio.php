  ...
  <div class="panel panel-default">
    <div class="panel-body">
      ...
      if ($this->row->picture) {
        ...
        ?>
        <div class="col-md-4 col-sm-6 col-xs-12"><img src='<?php echo $imgLoc; ?>' class="img-thumbnail"/></div>
        <?php }
      ?>
      ...
      if (!empty($this->row->video_link)) {
        ...
        <div class="col-md-8">
          <object width="100%" height="auto">
            ...
            <embed src="https://www.youtube.com/v/<?php echo $videoId; ?>?version=3" type="application/x-shockwave-flash" allowscriptaccess="always" width="100%" height="400px"></embed>
          </object>
        </div>
        <?php
      }
