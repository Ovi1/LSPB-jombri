  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <?php if (/* count($this->portfolios) == 0 ||  */$this->row->id > 0 || ($type == 'addnew' && $allowedPortfolio > 0)) { ?>
        ...
        <div class="input-group">
          <label class="input-group-addon" for="published"><?php echo JText::_('COM_JBLANCE_PUBLISHED'); ?>:</label>
          <div class="controls">
        ...
        <div class="input-group">
          <label class="input-group-addon" for="description"><?php echo JText::_('COM_JBLANCE_DESCRIPTION'); ?>:</label>
          <div class="controls">
            <textarea name="description" id="description" class="form-control required hasTooltip" rows="3"><?php echo JFilterInput::getInstance()->clean($this->row->description, 'string'); ?></textarea>
          </div>
        </div>
        <div class="input-group">
          <label class="input-group-addon" for="published"><?php echo JText::_('COM_JBLANCE_PORTFOLIO_IMAGE'); ?>:</label>
          <div class="controls">
            <?php
            if ($this->row->picture) {
        ...
        <div class="input-group">
          <label class="input-group-addon" for="published"><?php echo JText::_('COM_JBLANCE_ATTACHMENT'); ?>:</label>
          <div class="controls">
            <?php
